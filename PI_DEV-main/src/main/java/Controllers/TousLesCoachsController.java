...
public class TousLesCoachsController {
    ...
    @FXML
    void GoToHome(javafx.event.ActionEvent actionEvent) {
        try {
    ...
    @FXML
    void GoToProduit(javafx.event.ActionEvent actionEvent) {
        try {
    ...
    @FXML
    void GoToSeance(javafx.event.ActionEvent actionEvent) {
    ...
    @FXML
    void GoToRec(javafx.event.ActionEvent actionEvent) {
        try {
    ...
    @FXML
    void GoToOffre(javafx.event.ActionEvent actionEvent) {
        try {
