...
public class Main {
    public static void main(String[] args) {
        ...
        try {
            ...
            OffreCoach offreCoach = new OffreCoach(5, "Coaching baha", "Séances de coaching personnalisé", new Date(), Etato.ACTIF, 2, 100.0, 5, 10);
            ...
            Offre offre1 = new Offre(6, "Nom original", "Description originale", new Date(), Etato.ACTIF);
            ...
            OffreProduit offreProduit = new OffreProduit(4, "Produit A", "Description du produit A", new Date(), Etato.ACTIF, 1, 50.0, 100, 20);
