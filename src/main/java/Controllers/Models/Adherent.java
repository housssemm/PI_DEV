...
public class Adherent extends User {
    ...
    private Models.NiveauA niveau_activites;

    public Adherent() {
    }

    public Adherent(int id, String nom, String prenom, String image, String email, String MDP, Models.NiveauA niveau_activites, ObjP objectif_personnelle, GenreG genre, int age, float taille, float poids) {
    ...
    public Adherent(String nom, String prenom, String image, String email, String MDP, float poids, float taille, int age, GenreG genre, ObjP objectif_personnelle, Models.NiveauA niveau_activites) {
    ...
    public Models.NiveauA getNiveau_activites() {
