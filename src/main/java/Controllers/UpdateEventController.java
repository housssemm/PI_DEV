...
//    @FXML
//    private Button uploadButton; // Bouton d'importation d'image
//
...
//    private Events parentController; // Pour rafraîchir après modification
//    @FXML
...
//    }
//    //
//    public void setEventData(Evenement event, Events parentController) {
//        this.event = event;
...
//            event.setDateDebut(dateD.getValue());
//            event.setDateFin(dateF.getValue());
//
