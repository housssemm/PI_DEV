...
public class UserData extends User {
    ...
    private NiveauA niveauActivite;
    ...
    public NiveauA getNiveauActivite() { return niveauActivite; }
    public void setNiveauActivite(NiveauA niveauActivite) { this.niveauActivite = niveauActivite; }
    ...
    public SpecialiteC getSpecialite() { return specialite; }
    public void setSpecialite(SpecialiteC specialite) { this.specialite = specialite; }
