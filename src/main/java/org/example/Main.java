...
public class Main {
    public static void main(String[] args) {
        ...
        try {
//            Categorie categ = new Categorie(2,"aaa");
...
//            categs.delete(6);
//
            produit prod = new produit( 2, "ooo", "Haltères réglables pour musculation", "https://example.com/dumbbells.jpg", etat.Stock, 2, 50);
            ...
            produit prod2 = new produit(2, 2, "oo", "Tapis de course pliable avec écran LED", "https://example.com/treadmill.jpg", etat.Stock, 8, 500);
//            prods.create(prod);
//            prods.update(prod2);
//            prods.delete(2);
//
            panier p =new panier(null,115);
